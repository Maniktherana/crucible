...
export const CLIENT_SETTINGS_STORAGE_KEY = "crucible:client-settings:v1";
export const SAVED_ENVIRONMENT_REGISTRY_STORAGE_KEY = "crucible:saved-environment-registry:v1";
